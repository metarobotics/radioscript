...
local function init()
  ...
  FlightModeWavFile[1]="sudong.wav"       -- flight mode 0
  FlightModeWavFile[2]=""       -- flight mode 1
  FlightModeWavFile[3]="godo.wav"       -- flight mode 2
  FlightModeWavFile[4]="godo.wav"       -- flight mode 3
  FlightModeWavFile[5]=""       -- flight mode 4
  FlightModeWavFile[6]="gps.wav"       -- flight mode 5
